...
window.TODO = {
    ...
    renderUI: function () {
        ...
        if (!this.todoApp.todos) return;

        this.todoApp.todos.forEach(function (todo) {
        ...
        total = this.todoApp.countTodos();
        totalNotDone = this.todoApp.countNotDone();
    ...
    todoHandler: function (e) {
        ...
        if (target.classList.contains('js-todo-item-done')) {
            ...
            this.todoApp.addTodo(description);
        } else return;
    ...
    addHandler: function (e) {
        ...
        this.todoApp.addTodo(e.target.value);
        this.renderUI();
    }
};
